...
CLUSTERS: dict[str, tuple[str, list[tuple[str, str]]]] = {
    ...
    "skin_science": (
        ...
        [
            ...
            ("The dermis — where ink lives", "/dermis_skin_science_las_vegas_authority_guide/"),
            ("Scar tissue & tattoos", "/scar_tissue_tattoo_skin_science_las_vegas_authority_guide/"),
            ("Aging skin & tattoo clarity", "/aging_skin_skin_science_las_vegas_authority_guide/"),
    ...
    "cover_up": (
        ...
        [
            ...
            ("Premium studio vs cheap Strip shops", "/vegas_tattoo_shop_vs_cheap_strip_tattoo_ultimate_comparison/"),
            ("Tattoo pricing guide", "/how_much_do_tattoos_cost_in_las_vegas_authority_guide/"),
            ("Free cover-up consult", "/appointments/"),
        ],
    ),
    "piercing": (
        ...
        [
            ...
            ("Studio videos — piercing", "/studio_videos/#katelyn-piercing"),
            ("Book piercing", "/appointments/"),
        ],
    ),
    "walk_in": (
