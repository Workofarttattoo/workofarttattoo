...
def main() -> int:
    ...
    with (audits / "entity-conflicts.md").open("w", encoding="utf-8") as f:
        ...
        f.write("Correct business values: Work of Art Tattoo & Piercing; 2375 E. Tropicana Ave, Suite 3, Las Vegas, NV 89119; (725) 224-1240; thewhiteknight702@gmail.com; 3 resident artists; 5.0 rating; hundreds of Google reviews.\n\n")
    ...
    with (audits / "content-gap-opportunities.csv").open("w", newline="", encoding="utf-8") as f:
        ...
        topics = [
            ...
            ("Piercing starter jewelry", "Choose safe starter jewelry", "/piercing_jewelry_guide_las_vegas/", 60, "high", "Katelyn Cole", "partial", "Improve existing jewelry guide and link to piercing hub", "P1"),
