...
def sitewide_conversion_block(*, compact: bool = False) -> str:
    """Text us · reference photo · walk-in policy."""
    if compact:
...
<li><strong class="text-on-surface">Send a reference photo</strong> to <a class="text-secondary underline hover:no-underline" href="{HREF_BOOKING_MAILTO}">booking@workofarttattoo.com</a> with placement, size, and timeline.</li>
