...
from woa_nav_config import HREF_BOOKING_MAILTO, STUDIO_BOOKING_LINK_LABEL
...
<p class="font-body-md text-on-surface-variant mb-12"><a class="text-secondary underline hover:no-underline" href="/appointments/">Book an appointment</a> · <a class="text-secondary underline hover:no-underline" href="tel:+17252241240">(725) 224-1240</a> · <a class="text-secondary underline hover:no-underline" href="{HREF_BOOKING_MAILTO}">{STUDIO_BOOKING_LINK_LABEL}</a></p>
...
<a class="font-label-caps text-label-caps text-secondary uppercase tracking-widest hover:underline" href="/artists/teralyn/">Teralyn — Tattoos &amp; Piercing Bio →</a>
</div>
</section>
