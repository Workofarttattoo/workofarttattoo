...
<details class="group bg-surface border border-outline-variant/30 p-6 cursor-pointer hover:border-secondary transition-all"><summary class="flex justify-between items-center font-headline-md list-none">Where is the studio?<span class="material-symbols-outlined group-open:rotate-180 transition-transform">expand_more</span></summary><p class="mt-4 font-body-md text-on-surface-variant">Work of Art Tattoo &amp; Piercing — {STUDIO_ADDRESS_SINGLE_LINE}. <a class="text-secondary underline" href="/tattoo_shop_near_the_strip_nap_corrected/">Directions &amp; hours</a></p></details>
</div>
</section>
