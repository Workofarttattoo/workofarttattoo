...
HASH_TEXT_HREFS: list[tuple[re.Pattern[str], str]] = [
    ...
    (re.compile(r"meet\s+(the\s+)?artists?", re.I), "/#meet-our-artists"),
    (re.compile(r"^artists$", re.I), "/#meet-our-artists"),
    ...
    (re.compile(r"black\s*&\s*grey\s*realism", re.I), "/realism_tattoos_las_vegas_master_authority_guide/"),
    (re.compile(r"color\s*realism", re.I), "/realism_tattoos_las_vegas_master_authority_guide/"),
    ...
    (re.compile(r"cover-?up", re.I), "/how_to_choose_a_tattoo_artist_master_selection_guide_2/"),
    (re.compile(r"ear\s*piercing", re.I), "/best_piercing_shop_las_vegas_updated_jewelry_standards/"),
    (re.compile(r"facial\s*piercing", re.I), "/best_piercing_shop_las_vegas_updated_jewelry_standards/"),
    (re.compile(r"body\s*piercing", re.I), "/best_piercing_shop_las_vegas_updated_jewelry_standards/"),
    (re.compile(r"jewelry\s*upgrade", re.I), "/best_piercing_shop_las_vegas_updated_jewelry_standards/"),
    (re.compile(r"aftercare\s*guide", re.I), "/tattoo_healing_in_desert_climate_expert_aftercare_guide/"),
    (re.compile(r"studio\s*tour", re.I), "/tattoo_shop_near_the_strip_nap_corrected/"),
    (re.compile(r"gift\s*cards?", re.I), "/appointments/"),
    (re.compile(r"get\s*directions", re.I), "/tattoo_shop_near_the_strip_geo_seo_optimized/"),
]
