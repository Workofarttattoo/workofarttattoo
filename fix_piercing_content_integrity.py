...
REPLACEMENTS: tuple[tuple[re.Pattern[str], str], ...] = (
    ...
    (re.compile(r"We use properly fitted initial jewelry selected for the placement and your anatomy\. Ask the studio to confirm current material options before booking\.", re.I), "We choose starter jewelry by anatomy, swelling room, placement, and sensitivity history. Ask the studio to confirm current material options before booking."),
