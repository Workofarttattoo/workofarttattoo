...
GEO_PAGES: tuple[GeoPage, ...] = (
    ...
    GeoPage(
        ...
        related_guides=(
            ("Walk-in vs appointment", "/walk-in-tattoos-las-vegas/"),
            ("Strip vs studio comparison", "/vegas_tattoo_shop_vs_cheap_strip_tattoo_what_you_need_to_know/"),
    ...
    GeoPage(
        ...
        related_guides=(
            ...
            ("Realism portfolio", "/realism-tattoos-las-vegas/"),
    ...
    GeoPage(
        ...
        related_guides=(
            ...
            ("Tattoo flying after session", "/knowledge/tattoo-flying-after-session/"),
            ("Walk-in guide", "/walk-in-tattoos-las-vegas/"),
            ("Appointments", "/appointments/"),
        ),
    ),
    GeoPage(
        ...
        related_guides=(
            ...
            ("Strip guide", "/tattoo_shop_near_the_strip_nap_corrected/"),
            ("Tattoo aftercare in Vegas", "/tattoo-aftercare-desert-climate/"),
            ("Appointments", "/appointments/"),
        ),
    ),
    GeoPage(
    ...
    GeoPage(
        ...
        related_guides=(
            ("Downtown Las Vegas guide", "/tattoo_shop_near_the_strip_nap_corrected/"),
            ("Walk-in tattoo guide", "/walk-in-tattoos-las-vegas/"),
            ("Tattoo aftercare in Vegas", "/tattoo-aftercare-desert-climate/"),
            ("Teralyn portfolio", "/artists/teralyn/"),
            ("Appointments", "/appointments/"),
