...
REPLACEMENTS: tuple[tuple[re.Pattern[str], str], ...] = (
    ...
    (re.compile(r"\bmedical-grade hygiene\b", re.I), "clean studio process"),
    (re.compile(r"\bmedical-grade surgical steel\b", re.I), "starter jewelry options"),
    (re.compile(r"\bmedical-grade disinfectants\b", re.I), "studio disinfectants"),
    (re.compile(r"\bhospital-grade protocols\b", re.I), "documented studio procedures"),
    (re.compile(r"\bhospital-grade antiseptic\b", re.I), "clean procedure-room setup"),
